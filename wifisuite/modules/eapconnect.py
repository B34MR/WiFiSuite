...
class eapConnect(threading.Thread):
	def __init__(self, db_path, ssid, user, password, ca_cert, ca_path, client_cert, supplicantInt, interface):
	...
	def database_connect(self):
		try:
			...
			print(red('!')+'WARNING - (EAPCONNECT) Could not connect to database: %s' % (e))
			pass
